...
public class MainActivity2 extends BaseCastActivity implements
    ...
    public void onResume() {
        ...
        DialogUtils.showUpgradeNagDialog(this, (materialDialog, dialogAction) -> {
            if (ShuttleUtils.isAmazonBuild()) {
                ShuttleUtils.openShuttleLink(MainActivity2.this, "com.simplecity.amp_pro");
            } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_share:
                DialogUtils.showShareDialog(MainActivity2.this, MusicUtils.getSong());
                return true;
    ...
    public void themeColorChanged() {
        ...
        if (drawerLayout != null && ShuttleUtils.hasKitKat()) {
            drawerLayout.setStatusBarBackgroundColor(ShuttleUtils.hasLollipop() ? ColorUtils.getPrimaryColorDark(MainActivity2.this) : ColorUtils.getPrimaryColor());
        }
        if (SettingsManager.getInstance().canTintNavBar()) {
            getWindow().setNavigationBarColor(ColorUtils.getPrimaryColorDark(MainActivity2.this));
        }
        themeTaskDescription();
    }
    ...
    private IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
            ...
            if (sku.equals(Config.SKU_PREMIUM)) {
                ...
                DialogUtils.showUpgradeThankyouDialog(MainActivity2.this);
            }
        }
    };
