 ...
 * our case, is implemented by {@link MusicService}). This class can only be
 * used on SDK level 8 and above, since it uses API features that are not
...
public class AudioFocusHelper implements
    ...
    /**
     * Constructor for AudioFocusHelper.
     *
     * @param ctx       Context
     * @param focusable MusicFocusable
     */
    ...
    /**
     * Requests audio focus. Returns whether request was successful or not. * @return
     * boolean
     */
    ...
    /**
     * Abandons audio focus. Returns whether request was successful or not. * @return
     * boolean
     */
