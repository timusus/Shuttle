...
public class AlbumArtistMenuUtils {
    ...
    public static Toolbar.OnMenuItemClickListener getAlbumArtistMenuClickListener(Context context, Single<List<AlbumArtist>> selectedAlbumArtists, Callbacks callbacks) {
        return item -> {
            switch (item.getItemId()) {
                ...
                case R.id.addToQueue:
                    MenuUtils.addToQueue(AlbumArtistExt.INSTANCE.getSongsForAlbumArtists(selectedAlbumArtists), callbacks::onQueueItemsInserted);
                    return true;
                case R.id.delete:
    ...
    public static PopupMenu.OnMenuItemClickListener getAlbumArtistClickListener(Context context, AlbumArtist albumArtist, Callbacks callbacks) {
        return item -> {
            switch (item.getItemId()) {
                case R.id.play:
                    MenuUtils.play(AlbumArtistExt.INSTANCE.getSongsForAlbumArtist(albumArtist), callbacks::showToast);
                    return true;
                case R.id.playNext:
                    ...
                    AlbumArtistExt.INSTANCE.getSongsForAlbumArtist(albumArtist)
                            ...
                            .subscribe(songs -> MenuUtils.playNext(songs, callbacks::showToast));
                    return true;
                case R.id.albumShuffle:
                    MenuUtils.play(AlbumArtistExt.INSTANCE.getSongsForAlbumArtist(albumArtist).map(Operators::albumShuffleSongs), callbacks::showToast);
                    return true;
                case MusicUtils.Defs.NEW_PLAYLIST:
                ...
                case MusicUtils.Defs.PLAYLIST_SELECTED:
                    ...
                    return true;
                case R.id.addToQueue:
                    MenuUtils.addToQueue(AlbumArtistExt.INSTANCE.getSongsForAlbumArtist(albumArtist), callbacks::onQueueItemsInserted);
                    return true;
                case R.id.editTags:
