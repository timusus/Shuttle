...
public class ViewDragHelper {
     ...
     */
    public boolean smoothSlideViewTo(View child, int finalLeft, int finalTop, boolean smoothSlide) {
        mCapturedView = child;
        mActivePointerId = INVALID_POINTER;

        return forceSettleCapturedViewAt(finalLeft, finalTop, 0, 0, smoothSlide);
    }
     ...
     * @return true if animation should continue through {@link #continueSettling(boolean)} calls
     */
    private boolean forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel, boolean smoothSlide) {
        ...
        final int duration = smoothSlide ? computeSettleDuration(mCapturedView, dx, dy, xvel, yvel) : 0;
